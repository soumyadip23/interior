...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('staff.lead.create') }}" class="btn btn-primary pull-right">Add New</a>
    </div>
                            ...
                            @foreach($leads as $key => $lead)
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('staff.lead.edit', $lead['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('staff.lead.details', $lead['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
