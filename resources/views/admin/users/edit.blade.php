                ...
                <form action="{{ route('admin.users.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('account_no') is-invalid @enderror" type="text" autocomplete="off" name="account_no" id="account_no" value="{{ old('account_no', $targetUser->account_no) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="searchTextField" value="{{ old('address', $targetUser->address) }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control categorySelect @error('cat_id') is-invalid @enderror" name="cat_id[]" name="cat_id[]" multiple="multiple">
