            ...
            <div class="tile">
                <h3 class="tile-title">{{ $subTitle }}
                    <span class="top-form-btn">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Incentive</button>
                        <a class="btn btn-secondary" href="{{ route('admin.incentive.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </span>
                </h3>
                <hr>
                <form action="{{ route('admin.incentive.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="control-label" for="value">Incentive Value <span class="m-l-5 text-danger"> *</span></label>
