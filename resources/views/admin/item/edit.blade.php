                ...
                <form action="{{ route('admin.item.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <?php echo $targetitem->category_id; ?>
                    ...
                    <?php  foreach ($targetitem['itemVariation'] as $itemvari){ ?>
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label" for="unit">Varient Name <span class="m-l-5 text-danger"> *</span></label>
                                <input class="form-control" type="text" name="vname[]" id="name" value="{{ $itemvari['name'] }}"/>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label" for="unit">Unit <span class="m-l-5 text-danger"> *</span></label>
                                <input class="form-control" type="text" name="unit[]" id="unit" value="{{ $itemvari['unit'] }}"/>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label" for="price">Price <span class="m-l-5 text-danger"> *</span></label>
                                <input class="form-control"  name="price[]" id="price" value="{{ $itemvari['price'] }}"/>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="in_stock[]" id="in_stock">
                                    ...
                                    <option value="1" {{ $itemvari['in_stock'] == '1' ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ $itemvari['in_stock'] == '0' ? 'selected' : '' }} >No</option>
                                </select>
                            </div>
                        </div>
                    </div>
