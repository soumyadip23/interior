...
<html lang="en">
  <head>
    ...
    <title>Interior Vendor Login</title>
              ...
              <div class="col-md-12 col-lg-7 contents" data-aos="fade-down" data-aos-duration="2000">
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <form class="login-form" action="{{ route('vendor.login.post') }}" method="POST" role="form">
                        ...
                        <div class="form-group d-flex align-items-center justify-content-between">
                            ...
                            <a class="" href="{{ route('vendor.password.request') }}">Forgot Your Password?</a>
                        </div>
                    ...
                    <div class="create-account mt-4">
                      <span>Dont have an account? <a href="{{ route('vendor.register') }}">Create an account</a></span>
                    </div>
                  </div>
                </div>
